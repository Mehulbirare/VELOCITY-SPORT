               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="https://www.hindustantimes.com/ht-img/img/2023/08/29/550x309/pexels_1693295846485_1693295853881.jpg" alt="" class="img-fluid">
                        <p></p>
                     
                        <!-- end:Panel -->
                        <h4 class="m-t-20">Contact Customer Support</h4>
                        <p> If you"re looking for more help or have a question to ask, please </p>
                        <p> <a href="mailto:mehul@gmail.com" class="btn theme-btn m-t-15">Mail us</a> </p>
                     </div>
                     <!-- /WHY? -->
                  </div>
               </div>
